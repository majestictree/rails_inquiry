...
class InquiriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inquiry" do
    assert_difference('Inquiry.count') do
      post inquiries_url, params: { inquiry: { body: @inquiry.body, email: @inquiry.email, name: @inquiry.name, purpose: @inquiry.purpose } }
    end
  ...
  test "should update inquiry" do
    patch inquiry_url(@inquiry), params: { inquiry: { body: @inquiry.body, email: @inquiry.email, name: @inquiry.name, purpose: @inquiry.purpose } }
